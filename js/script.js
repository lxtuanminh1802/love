...
function troll() {
    ...
    const y = document.getElementById("fbut3");
      ...
      document.getElementById("alert2").innerHTML = "Ấn nút này là phải làm em bé của anh típ òi >< 😛";
      document.getElementById("audio2").play();
      return false;
}
function troll1() {
...
function inrel() {
    ...
    const b = document.getElementById("fbut2alt");
     ...
     c.innerHTML = "";
     c.innerHTML = "Cố iu nhau ngày này qua ngày khác mà không nghĩ đến tương lai nhớ =))";
     y.style.display="none";
     x.style.display="inline";
     document.getElementById("audio3").play();
     document.getElementById("alert2").innerHTML = "";
     document.getElementById("des").innerHTML = "Nếu hong phiền thì lại làm người yêu anh ikk 😳";
     return false;
...
function trollalt() {
    document.getElementById("alert2").innerHTML="Sao lại không muốn ? Em sẽ rất bất ngờ đấy !";
    alert("Sao lại không muốn ? Em sẽ rất bất ngờ đấy !");
    return false;
}
